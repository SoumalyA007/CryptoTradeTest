//package com.soumalya.CryptoTrade.config;
//
//
...
//                                String fullName=userDetails.getAttribute("name");String phone=userDetails.getAttribute("phone");
...
//                        "http://localhost:5174",
//                        "http://localhost:4200",
//                        "https://cryptotradetest-production.up.railway.app"
//
//                ));
...
public class AppConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(withDefaults()); // Uses the @Bean defined below automatically

        return http.build();
    }

    // ✅ Updated: Define CORS as a separate @Bean
    @Bean
    CorsConfigurationSource corsConfigurationSource() {
        return request -> {
            ...
            cfg.setAllowedOrigins(Arrays.asList(
                    ...
                    "http://localhost:5174",
                    "http://localhost:4200",
                    "https://cryptotradetest-production.up.railway.app" // Corrected with HTTPS
                    // Add your frontend's domain if deployed elsewhere
            ));
    ...
    // Optional: Add a CorsFilter explicitly (can be useful in some cases)
    @Bean
